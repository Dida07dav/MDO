...
# f = open(r'C:\Pacharm225.d\text.txt', 'r')
#
# # print(f.closed)
# # print(f.mode)
# # print(f.name)
...
#
#
# print("Минимальное число:", Numbers.minimum(4, 5, 9, 2))
# print("Максимальное число:", Numbers.maximum(4, 5, 9, 2))
# print("Среднее арифметическое:", Numbers.sr_arifm(4, 5, 9, 2))
...
# print("Фамилия Имя Отество: ", p1.fio)
# p1.old = 35
# print("Возраст: ", p1.old)
# p1.password = '4567 123456'
# print("Номер и серия паспорта:",p1.password)
# p1.weight = 70.0
# print("Вес: ", p1.weight, "кг")
# print(p1.__dict__)
...
#     def calc_m(self, v):
#         m = v * self.density
#         print(f'Вес {v} m^3 of {self.name} состовляет {m}кг')
#
#     def print_info(self):
...
#             print("Я метод внутреннего класса", MyOuter.age)
...
# print("pt =", pt.__sizeof__() + pt2.__dict__.__sizeof__())
...
# import os
#
# from beauty_salon.database import DATABASE_BEAUTY
...
# 	print("*" * 60)
	...
	# print("*" * 60)
	# print(name_of_service.query(Services).get(3))
	# print("*" * 60)
	# for it in name_of_service.query(Services).filter(Services.id >= 3, Services.service_title.like('в%')):
	# 	print(it)

	# for it, gr in name_of_service.query(Services.service_title, Price.price_list).filter(and_(
	# 		 Price.price_list =='KM-1')):
	# 	print(it, gr)
	# print ("*" * 60)

	# for it in name_of_service.query(Specialists).join(Price).filter(Price.price_list == 'KM-1'):
	# 	print(it)
	# print("*" * 60)
	#
	# for it in name_of_service.query(distinct(Specialists.age)):
	# 	print(it)
	# print("*" * 60)
	#
	# for it in name_of_service.query(Specialists.age).filter(Specialists.age < 31).distinct():
	# 	print(it)
	# print("*" * 60)
	
	# i = name_of_service.query(Services).get(5)
	# i.service_title = "Кератин - 5500"
	# name_of_service.add(i)
	...
	# print("*" * 60)
	#
	# name_of_service.query(Services).filter(
	# 	Services.service_title.like("%м%")).update({"service_title": "М"}, synchronize_session="fetch")
	# name_of_service.commit()
	...
	# name_of_service.add(Services(service_title="Восстановление - 2200"))
	# name_of_service.commit()
	...
	# print("*" * 60)
	#
	# i = name_of_service.query(Services).filter(Services.service_title == "Восстановление - 2200").first()
	# name_of_service.delete(i)
	# name_of_service.commit()
	#
	# for it in name_of_service.query(Services):
	# 	print(it.service_title)
